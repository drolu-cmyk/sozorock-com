(()=>{'use strict';
 ...
 const endpoint=window.SOZOROCK_CONTACT?.apiEndpoint,corporate=root.dataset.context==='corporate';
 ...
 form.addEventListener('submit',async event=>{
  ...
  const payload=Object.fromEntries(new FormData(form));payload.context=corporate?'corporate':'school';payload.intent=payload.intent||'general';
