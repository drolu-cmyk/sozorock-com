...
import {LEGACY,ROUTES,PRIVATE_ROUTES} from '../src/site.mjs';
export function routingSource(release='') {
 ...
 return `var redirects=${JSON.stringify(LEGACY)};var routes=${JSON.stringify([...ROUTES,...PRIVATE_ROUTES])};var release=${JSON.stringify(release)};\n`+readFileSync(new URL('../infra/aws/public-routing.js',import.meta.url),'utf8');
}
