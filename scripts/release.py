...
ASSET=re.compile(r'(?<=[\x22\x27(])/(assets/|media/|corporate\.css|corporate\.js|cbcap-preview\.js|school\.css|school-nav\.js|applications\.js|offers\.js|contact\.js|favicon\.svg|favicon-48\.png|apple-touch-icon\.png)')
